Sub Macro()
    ...
    Sheets(1).Name = IdFile1
    Sheets(2).Name = IdFile2
    Sheets(3).Name = IdFile1 & " div " & IdFile2
    ...
    For Each objfile In objFolder.Files
        ...
        If (InStr(1, File, IdFile1) = 0 And InStr(1, File, IdFile2) = 0) Then
            GoTo ContinueLoop
        End If
        ...
        If InStr(1, File, IdFile1) <> 0 Then
            ...
            Next
        ElseIf InStr(1, File, IdFile2) <> 0 Then
    ...
    Workbooks(FileDate).Worksheets(3).Activate
    Workbooks(FileDate).Worksheets(3).Range(Cells(3, 4), Cells(r + 2, ctotal + 2)).Formula = "=IF(ISBLANK('" & IdFile1 & "'!D3)," & Chr(34) & Chr(34) & ",'" & IdFile1 & "'!D3/'" & IdFile2 & "'!D3)"

    Workbooks(FileDate).Worksheets(4).Activate
    Workbooks(FileDate).Worksheets(4).Range(Cells(3, 4), Cells(r + 2, ctotal + 2)).Formula = "=IF(ISBLANK('" & IdFile1 & "'!D3)," & Chr(34) & Chr(34) & ",'" & IdFile1 & " div " & IdFile2 & "'!D3/AVERAGE('" & IdFile1 & " div " & IdFile2 & "'!D$3:D$13))"
